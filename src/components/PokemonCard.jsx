...
const PokemonCard = ({ pokemon }) => {
  ...
  return (
    <div className="border p-4 rounded shadow-lg hover:shadow-xl transition-shadow bg-white cursor-pointer">
      <div className="relative group bg-white border rounded-full w-40 h-40 mx-auto mb-4">
        ...
        <div className="absolute inset-x-0 top-1/2 transform -translate-y-1/2 h-2 bg-black"></div>
        ...
        <img
          ...
          alt={pokemon.name}
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-full w-32 h-32 opacity-0 group-hover:opacity-100 group-hover:-translate-y-1/2 transition-all duration-500"
        />
      </div>
